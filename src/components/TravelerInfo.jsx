...
// //       <div className="flex flex-col md:flex-row items-center justify-between pb-2 mb-4 border-b">
...
//       // Trigger search if searchPax has a value
//       if (value) {
//         await searchPassenger(value);
//       }
//     } else if (
//       name === "passportExpiry" &&
//       new Date(value) < sixMonthsFromNow
//     ) {
//       return; // Ignore if expiry date is too soon
//     } else {
//       // Update other fields
//       setTravelerDetails((prevDetails) => ({
//         ...prevDetails,
...
//       // Update passenger details with the first match (or modify as needed)
//       if (searchResult && searchResult.length > 0) {
//         setTravelerDetails({
//           ...travelerDetails,
//           ...searchResult[0], // assuming searchResult is an array of passengers
//         });
//       }
//     } catch (err) {
